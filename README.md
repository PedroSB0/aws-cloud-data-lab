...
A jornada documentada abaixo cobre desde a preparação do "terreno" (infraestrutura de rede VPC) até a validação do processamento e o encerramento dos recursos para otimização de custos.
...
![Criação Cluster](img/1CriaçãoCluster.png)
...
![Config cluster 2](img/2Configcluster1.png)
...
![Config cluster 3](img/3configcluster2.png)
...
![Criacao VPC](img/6CriacaoVPC.png)
...
![Fluxo de VPC](img/7FluxodeVPC.png)
...
![instancia EC2](img/9instanciaEC2.png)
...
![Cluster Criado](img/10ClusterCriado.png)
...
![Adicao de Etapa](img/11AdicaodeEtapa.png)
...
![Objeto](img/12EtapacomObjcompleto.png)
...
![Final Cluster encerrado](img/13FinalClusterencerrado.png)
